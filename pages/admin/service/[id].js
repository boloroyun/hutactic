...
function ServiceEdit({ params }) {
    ...
    if (!userInfo) {
      ...
      const fetchData = async () => {
        try {
          ...
          const { data } = await axios.get(`/api/admin/services/${serviceId}`, {
  ...
  return (
    <Layout title={`Edit Service ${serviceId}`}>
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <TextField
                            ...
                            error={Boolean(errors.serviceCategory)}
                            helperText={
...
export default dynamic(() => Promise.resolve(ServiceEdit), { ssr: false });
